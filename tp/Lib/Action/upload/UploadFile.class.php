	...
	private function save($file)
	{
		...
		) ))
		{
			...
			if (false !== $image)
			{
				...
				$thumbPath = $this->thumbPath?$this->thumbPath:array();
				...
				for ($i = 0, $len = count( $thumbWidth ); $i < $len; $i++)
				{
					...
					if (1 == $this->thumbType)
					{
						Image::thumb2( $filename, $thumbPath[$i] . $thumbname . '.' . $thumbExt, '', $thumbWidth[$i], $thumbHeight[$i], true );
					}
					else
					{
